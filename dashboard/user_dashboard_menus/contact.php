...
<body>	
  ...
  <div class="card">
    ...
    <div class="card-body text-center py-5">
      ...
      <h5 class="card-text">Vadodara</h5>
      <h5 class="card-text">Gujarat</h5>
  ...
  <div class="card">
    ...
    <div class="card-body text-center  py-5">
      ...
      <h5 class="card-title">Mobile : 9510509378</h5>
      <h5 class="card-title">Landline : 0472-370-5132</h5>
    </div>
  ...
  <footer id="site-footer">
      ...
      <div class="social-networks">
				...
				<a href="mailto:surakshanet@gmail.com?subject=Mail from Our Site" class="google"><i class="fab fa-google-plus-g"></i></a>
			</div>
			<div class="footer-copyright">
            	<p>&copy;2024 All Rights Reserved | Designed By <a href="https://www.linkedin.com/in/jaydeepraulji/"><span>Jaydeep Raulji</span></a> </p>
        	</div>
